...
uses
  Classes, SysUtils, fphttpapp, INIFiles, md5, uMemoryMessages;
...
var
   ...
   NumberOfSecondsBeforeDeleting  : integer;
   MemoryMessages                 : TMemoryMessages;
...
begin
     ...
     jwt_timeout                   := StrToIntDef(INI.ReadString('Config','JWTTimeOut',''),1); //1 minuto di default (qui le connessioni devono essere brevi)
     ...
     NumberOfSecondsBeforeDeleting := StrToIntDef(INI.ReadString('Config','NumberOfSecondsBeforeDeleting','120'),120);
