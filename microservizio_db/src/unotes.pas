...

{
 ...
 Questa applicazione ha lo scopo di funzionare da microservizio web per la connessione ai database
 così da non dover più aver librerie installare sui client.
